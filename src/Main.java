...
public class Main {
  ...
  // The time complexity is:
  // YOUR ANSWER HERE
  // 0(n) where n is the num of elements in the nums array
  ...
  // The time complexity is:
  // YOUR ANSWER HERE
  // O(n) where n is the lngth of the nums array 
  ...
  // The time complexity is:
  // YOUR ANSWER HERE
  // o(n) where n is value of n and we use in for loop
  ...
  // of the array
  // The time complexity is: O(n^2) where n is the legnth of the nums array.
  ...
  // The time complexity is:
  // O(n) where n is the number of element in arr -> until target is found or done w arr length
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n^2) where n is num of elem in wordsA and wordsB and wordsA = wordsB
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(n) where n is worldsA.length and wordB.length.
  // asumme that wordsA.length = wordsB.length like the last one.
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is:
  // O(1) -> call once and set.contains
  ...
  // O(1) we can use the query for HashMap 
  ...
  // O(n^2) where n is worldList and wordSet size 
  ...
  // O(n) where n is wordList size so we down from O(n^2) to O(n)
  ...
  // O(n) - Using HashMap 
  // keys -> Ticker symboys 
  // values -> current price of each stock
  ...
  // What would be a good choice of data structure?
  // Array List to use so you can access by position array index or add songs where you want in the length.
  ...
  // What would be a good choice of data structure?
  // TreeMap so it can keep the order like they want and they priotize order over searches
}